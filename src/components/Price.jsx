...
const Price = (props) => {
  ...
  return (
    <>
      <form onSubmit={onSubmitHandler} className="w-[120px] flex flex-col ">
        <label
          htmlFor="quantity-input"
          className="block mb-2 text-sm font-bold text-gray-900 underline dark:text-white dark:hover:text-gray-300"
        >
          Choose quantity:
        </label>
        <div className="relative flex items-center w-full gap-1 ">
          ...
          <Input
            ...
            className="bg-gray-50 border-x-0 border-gray-300  text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block dark:bg-gray-700 dark:border-gray-600 w-[4rem] mb-4 mr-3  dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="1"
            required
          />
          <button
